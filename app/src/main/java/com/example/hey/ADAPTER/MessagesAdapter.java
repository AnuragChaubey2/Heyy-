...
import com.example.hey.databinding.DeleteDialogBinding;
import com.example.hey.databinding.ItemSendBinding;
import com.example.hey.databinding.ReciverResourceBinding;
...
public class MessagesAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == ITEM_SENT) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.reciver_resource, parent, false);
    ...
    public class ReciveViewHolder extends RecyclerView.ViewHolder{
        ReciverResourceBinding binding;

        public ReciveViewHolder(@NonNull View itemView) {
            super(itemView);
            binding= ReciverResourceBinding.bind(itemView);
        }
    }
}